//https://www.youtube.com/watch?v=srhl7Ro__70&ab_channel=JuanCasteran (disculpe el audio)
...
void mousePressed() {
  if (escenas[0]==0) {
    if (mouseX>30 && mouseX<205 && mouseY>270 && mouseY<350) {
      for (int i=0; i<14; i++) {
        escenas[i]=1;
        escenas[1]=0;
      }
    ...
    if (mouseX>525 && mouseX<575 && mouseY>200 && mouseY<250) {
      for (int i=0; i<14; i++) {
        escenas[i]=1;
        escenas[2]=0;
      }
    ...
    if (mouseX>525 && mouseX<575 && mouseY>270 && mouseY<320) {
      for (int i=0; i<14; i++) {
        escenas[i]=1;
        escenas[6]=0;
      }
